...
<section id="main-content">
	<section class="wrapper">
		...
		<h3><i class="fa fa-angle-right"></i> เพิ่มประเภทรถยนต์ </h3>
				...
				<div class="content-panel">
					<center>
						...
						<table class="table table-hover">
							<h2> <i class="fa-solid fa-car-side"></i> เพิ่มประเภทรถยนต์ </h2>
							<hr>
							<thead>
							@if(count($data)==0)
                            <tr>
							...
							<tbody>
								<tr>
									...
									<td></td>
									<td>
										<form action="{{ route('typecar.destroy', $value->id) }}" method="post">
											@csrf
											@method('DELETE')
								...
								@endforeach
								<tr>
									<form action="{{ route('typecar.store') }}" class="form-horizontal style-form" method="post">
										@csrf
										<td></td>
										<td>เพิ่มประเภทรถยนต์</td>
										<td><input type="text" class="form-control"  required="required" name="name"></td>
										<td>
						...
						<!-- form edit -->
						@foreach ($data as $key => $value)
						<form action="{{ route('typecar.update', $value->id) }}" method="post">
							@csrf
							@method('PUT')
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											...
											<center>
												<h4 class="modal-title">แก้ไขประเภทรถยนต์</h4>
											</center>
										</div>
