...
<section id="main-content">
    <section class="wrapper">
        ...
        <h3><i class="fa-solid fa-car"></i>แก้ไขเพิ่มรถยนต์</h3>

        <!-- BASIC FORM ELELEMNTS -->
        <form method="post" action="{{ route('userlist.update',$user[0]->id) }}">
             @csrf
             @method('PUT')
            <div class="row mt">
                <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control" name="type_id">
                                        <option value=""> {{ $car[0]->types->name }}</option>

                                    </select>
                                </div>
                                <label class="col-sm-1 control-label">เลขทะเบียน</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="regisNumber" value="{{ $car[0]->regisNumber }}">
                                    <br><br>
                                </div>
                                <!-- Close Row 1-->
